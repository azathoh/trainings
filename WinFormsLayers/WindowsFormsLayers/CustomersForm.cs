...
namespace WindowsFormsLayers
{
    public class CustomersForm : Form
    {
        ...
        public CrmManager CrmManager { get; set; }
        ...
        {
            List<Company> companies = CrmManager.FetchCompanies(new CompanySearchCriteria(name: null));
        ...
        private void dataGridView1_SelectionChanged(object sender, System.EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count == 1)
            {
                ...
                if (selectedRow != null)
                {
                    ...
                    {
                        var employees = CrmManager.FetchEmployees(new EmployeeSearchCriteria(companyName: company.Name));
        ...
        private void button1_Click(object sender, System.EventArgs e)
        {
            ...
            {
                var companyTuple = addCompanyForm.NewCompany;
                if (CrmManager.Validate(companyTuple))
                {
